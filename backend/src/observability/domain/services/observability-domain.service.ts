...
export class ObservabilityDomainService {
    ...
    static buildOfflineEvent(deviceId: string, projectId: string): { type: 'device_offline'; deviceId: string; projectId: string; timestamp: string } {
        return {
            type: 'device_offline',
            deviceId,
            projectId,
    ...
    static buildDeviceStateUpdate(deviceId: string): { key: string; data: Record<string, string> } {
        return {
