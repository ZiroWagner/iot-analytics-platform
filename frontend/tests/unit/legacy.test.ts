...
import { isLegacyFormat, migrateLegacyConfig } from '@/features/analytics/domain/legacy'
import { CHART_COLORS } from '@/features/analytics/domain/chart-colors'
import { DEFAULT_WIDGET_CONFIG, type LegacyChartConfig } from '@/features/analytics/domain/types'
